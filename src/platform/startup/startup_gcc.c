...
void (* const g_pfnVectors[])(void) =
{
    ...
    Timer1_IntHandler,                      // Timer 1 subtimer A
    IntDefaultHandler,                      // Timer 1 subtimer B
    Timer2_IntHandler,                      // Timer 2 subtimer A
    ...
    Timer3_IntHandler,                      // Timer 3 subtimer A
    ...
    Timer4_IntHandler,                      // Timer 4 subtimer A
    ...
    0,                                      // Reserved
    0,                                      // Reserved
    Timer5_IntHandler,                      // Timer 5 subtimer A
